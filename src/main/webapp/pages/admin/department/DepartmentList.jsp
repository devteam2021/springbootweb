...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/lib/laydate/laydate.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/lib/jquery/1.9.1/jquery.form.js"></script>
<script type="text/javascript" src="DepartmentAdd.js"></script>
<title>project</title>
</head>
<body>
