...
<link rel="stylesheet"
	...
	media="all">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/layui/css/admin.css"
	media="all">

<script src="${pageContext.request.contextPath}/static/layui/hm.js"></script>

<link id="layuicss-layer" rel="stylesheet"
	href="${pageContext.request.contextPath}/static/layui/css/layer.css"
	media="all">
</head>
		...
		<div class="layui-layout layui-layout-admin">
			<div class="layui-header">
				...
				<ul class="layui-nav layui-layout-right"
					...
					<li class="layui-nav-item" lay-unselect=""><a
						href="javascript:;"> <cite>è´¤å¿</cite> <span
					...
					<li class="layui-nav-item layui-show-xs-inline-block layui-hide-sm"
						lay-unselect=""><a href="javascript:;" layadmin-event="more"><i
							class="layui-icon layui-icon-more-vertical"></i></a></li>
					<span class="layui-nav-bar"
						style="left: 252px; top: 48px; width: 0px; opacity: 0;"></span>
				</ul>
			</div>
