...
<script type="text/javascript" src="${pageContext.request.contextPath}/lib/html5.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/lib/PIE-2.0beta1/PIE_IE678.js"></script>
<![endif]-->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/lib/layer/3.0/layer.js"></script>
